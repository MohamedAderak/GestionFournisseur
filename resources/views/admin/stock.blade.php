    ...
    <div class="container grid px-6 mx-auto">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  ...
                  <div>
                    <p class="font-semibold">{{ $produit->product }}</p>
                  </div>
                </div>
              </td>
      ...
      <div class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800">
          <span class="flex items-center col-span-3">
              Showing {{ $stock->firstItem() }}-{{ $stock->lastItem() }} of {{ $stock->total() }}
          </span>
              ...
              <nav aria-label="Table navigation">
                  <ul class="inline-flex items-center">
                      <li>
                        ...
                        aria-label="Previous" @if(!$stock->previousPageUrl()) disabled @endif
                      >
                      ...
                      <li>
                          <a href="{{ $stock->nextPageUrl() }}"
                              ...
                              aria-label="Next"
                              @if(!$stock->nextPageUrl()) disabled @endif
                          >
